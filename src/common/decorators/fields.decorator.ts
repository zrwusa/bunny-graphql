...
export function EmailField(entityName?: string): PropertyDecorator {
...
export function UsernameField(entityName?: string): PropertyDecorator {
  return function (target: any) {
    if (!entityName) entityName = target.constructor.name;
    // ApiProperty({
...
export function IdField(entityName?: string): PropertyDecorator {
  return function (target: any) {
    if (!entityName) entityName = target.constructor.name;
    // ApiProperty({
